...
namespace Energy\Components\Exercises;
...
class Exercises
{
    ...
    public const TABLE_COLUMN_ID = 'ex_id';
    ...
    public const TABLE_COLUMN_PREFIX = 'ex_';
     ...
     * @var string
     */
    public const COMPONENT_NAME = 'exercises';
    ...
    public static function uploadImage(array $params = array()): array
    {
        ...
        $defParams = [
            ...
            'cropRequired' => false,
            'resize' => [
                'width' => Kernel::config('components/exercises', 'imageResizeMaxWidth'),
                'height' => Kernel::config('components/exercises', 'imageResizeMaxHeight')
            ],
            'thumbnail' => true,
            'thumbnailResize' => [
                'width' => Kernel::config('components/exercises', 'imageResizeThumbnailMaxWidth'),
                'height' => Kernel::config('components/exercises', 'imageResizeThumbnailMaxHeight')
            ]
        ];
