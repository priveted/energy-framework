...
namespace Energy\Core\Database;
...
class Database
{
     ...
     */
    public function query(string $statement, array $map = [],  array $ultraMap = []): ?PDOStatement
    {
    ...
    public function prepareMapData($map = array()): array
    {
        $r = [];
     ...
     * @return string
     */
    public function buildJoin(string $table, array $join, array &$map): string
    {
        $tableJoin = [];
        $type = [
            '>' => 'LEFT',
